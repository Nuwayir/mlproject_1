...
# NOTE : make sure to look into sys "custom exception handling in python" documention

def error_message_detail(error,error_detail:sys):
    _,_,exc_tb=error_detail.exc_info()# return od sys i'm just intersted in the 
